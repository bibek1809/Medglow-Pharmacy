...
comment on table public.admin_reports is 'MedGlow daily reporting ledger. Canonical dates are Gregorian; UI converts to Bikram Sambat.'; 
-- This migration is idempotent and safe to run in every environment.
